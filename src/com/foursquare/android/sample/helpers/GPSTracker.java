		...
		try {
			...
			if (!isGPSEnabled && !isNetworkEnabled) {
				...
				((Activity) mContext).runOnUiThread(new Runnable() {
					...
					@Override
					public void run() {
						StaticMethods.showDialogAlert(mContext, "Error", mContext.getString(R.string.open_mobile_network_Or_GPS_error_message), mContext.getString(R.string.ok_button), false);
					}
				});
			} else {
